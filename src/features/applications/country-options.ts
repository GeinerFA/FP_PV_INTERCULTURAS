...
export const publicCountryOptions: CountryOption[] = [
  ...
  { name: "Cote d'Ivoire", dialCode: "+225", flag: "🇨🇮" },
  ...
  { name: "Holy See", dialCode: "+379", flag: "🇻🇦" },
  ...
  { name: "Northern Mariana Islands", dialCode: "+1", flag: "🇲🇵" },
  ...
  { name: "Sint Maarten", dialCode: "+1", flag: "🇸🇽" },
  ...
  { name: "Turks and Caicos Islands", dialCode: "+1", flag: "🇹🇨" },
  ...
  { name: "Virgin Islands (British)", dialCode: "+1", flag: "🇻🇬" },
  { name: "Virgin Islands (U.S.)", dialCode: "+1", flag: "🇻🇮" },
  { name: "Yemen", dialCode: "+967", flag: "🇾🇪" },
  { name: "Zambia", dialCode: "+260", flag: "🇿🇲" },
  { name: "Zimbabwe", dialCode: "+263", flag: "🇿🇼" },
];

const supportedCountryNames = new Set(publicCountryOptions.map((option) => option.name));

export function isSupportedCountryName(value: string): boolean {
  return supportedCountryNames.has(value);
}
