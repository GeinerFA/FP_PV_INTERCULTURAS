...
export function AdminSidebarAccountControl({
  ...
  const triggerClassName =
    "relative flex h-12 w-12 cursor-pointer list-none select-none items-center justify-center overflow-hidden rounded-full border border-white/80 bg-white/72 text-sm font-semibold tracking-[0.18em] text-slate-700 shadow-[0_16px_38px_-28px_rgba(15,23,42,0.38)] transition hover:border-emerald-200 hover:bg-white hover:text-slate-950 focus-visible:bg-white focus-visible:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent [&::-webkit-details-marker]:hidden";
  const panelClassName =
    "surface-dark-soft-strong pointer-events-none absolute right-0 top-[calc(100%+0.875rem)] z-30 w-[min(19.5rem,calc(100vw-2rem))] origin-top-right translate-y-2 rounded-[28px] border border-white/85 p-5 text-left opacity-0 shadow-[0_30px_80px_-45px_rgba(15,23,42,0.28)] transition duration-150 ease-out group-open:pointer-events-auto group-open:translate-y-0 group-open:opacity-100";
